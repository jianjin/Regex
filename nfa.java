import java.util.*;
/*
 *Regular Expression example java version.
 */
...
public class nfa{
	...
	public static void main(String[] args) {
		...
		System.out.println(nfa.re2port("a(bb)+a"));
		System.out.println(nfa.re2port("(a(bb))+a"));
		System.out.println(nfa.re2port("a(bb)+a|abcd"));
		System.out.println(nfa.re2port("abdf|abcd"));
		System.out.println(nfa.re2port("abdf|abcd|jklm"));

		char[] post = j.re2port("a|d");
